...
static inline void Manager::loadbar(unsigned int x, unsigned int n, unsigned int w = 50) { // https://www.ross.click/2011/02/creating-a-progress-bar-in-c-or-any-other-console-app/
